...
CREATE DATABASE [Telefonszamok]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Telefonszamok_NLA01', FILENAME = N'C:\Users\User\Telefonszamok_NLA01.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Telefonszamok_NLA01_log', FILENAME = N'C:\Users\User\Telefonszamok_NLA01_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
